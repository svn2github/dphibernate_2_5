...
package com.hexagonstar.util.debug
{
	...
	public class StopWatch
	{
		...
		public static function startNew(title:String=""):StopWatch
		{
			var stopwatch:StopWatch = new StopWatch();
		...
		public function stopAndTrace():void
		{
			stop();
			trace(StringUtil.substitute("Stopwatch {0} completed in {1}ms",_title,getTimeInMilliSeconds()));
		}
		/**
